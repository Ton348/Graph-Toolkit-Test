...
public sealed class RequestCloseBusinessNodeValidator : IGameGraphNodeValidator
{
	public Type NodeType => typeof(RequestCloseBusinessNode);

	public bool Validate(GameGraphNode node, GameGraphValidationResult result)
	{
		if (!GameGraphBusinessValidatorHelpers.ValidateType(node, result, out RequestCloseBusinessNode typedNode))
		{
			return false;
		}
