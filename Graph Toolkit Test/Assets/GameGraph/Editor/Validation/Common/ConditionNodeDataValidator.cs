...
namespace GameGraph.Editor.Validation.Common
{
	...
	public sealed class ConditionNodeDataValidator : IGameGraphNodeValidator
	{
		...
		public bool Validate(GameGraphNode node, GameGraphValidationResult result)
		{
			...
			{
				ConditionType.BuildingOwned => GameGraphValidationHelpers.ValidateRequiredString(typedNode.buildingId,
					typedNode, nameof(typedNode.buildingId), result),
				ConditionType.QuestActive => GameGraphValidationHelpers.ValidateRequiredString(typedNode.questId, typedNode,
					nameof(typedNode.questId), result),
				ConditionType.QuestCompleted => GameGraphValidationHelpers.ValidateRequiredString(typedNode.questId,
					typedNode, nameof(typedNode.questId), result),
				_ => true
			};
