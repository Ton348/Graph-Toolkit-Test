...
namespace GameGraph.Editor.Validation.Infrastructure
{
	public static class GameGraphBusinessValidatorHelpers
	{
		public static bool ValidateType<TNode>(GameGraphNode node, GameGraphValidationResult result, out TNode typedNode)
