...
{
    protected override UniTask<GraphNodeExecutionResult> ExecuteTypedAsync(DialogueNode node, GraphExecutionContext context, CancellationToken cancellationToken)
    {
        ...
        return ExecuteWithServiceAsync(node, context.DialogueService, cancellationToken);
    }

    private static async UniTask<GraphNodeExecutionResult> ExecuteWithServiceAsync(DialogueNode node, IGraphDialogueService dialogueService, CancellationToken cancellationToken)
    {
