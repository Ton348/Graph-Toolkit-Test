...
[Serializable]
public class RequestOpenBusinessNodeModel : BusinessQuestLegacyBusinessNodeModel
{
    public const string LOT_ID_OPTION = "LotId";

    protected override string DefaultTitle => "Открыть бизнес";
    protected override string DefaultDescription => "Отправляет запрос на открытие бизнеса.";
