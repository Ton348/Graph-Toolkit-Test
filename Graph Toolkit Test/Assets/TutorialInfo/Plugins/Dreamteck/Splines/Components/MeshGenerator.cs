...
namespace Dreamteck.Splines
{
	public class MeshGenerator : SplineUser
	{
		...
		[SerializeField]
		[HideInInspector]
		private IndexFormat m_meshIndexFormat = IndexFormat.UInt16;
		...
		protected bool m_updateCollider;

		protected float m_vDist;
		...
		protected override void Reset()
		{
			...
			for (var i = 0; i < m_meshRenderer.sharedMaterials.Length; i++)
			{
			...
			if (!materialFound)
			{
				m_meshRenderer.sharedMaterial = AssetDatabase.GetBuiltinExtraResource<Material>("Default-Diffuse.mat");
			}
#endif
		}
