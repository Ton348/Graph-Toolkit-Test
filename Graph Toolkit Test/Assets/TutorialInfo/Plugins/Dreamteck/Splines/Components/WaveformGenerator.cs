				...
				for (var n = 0; n < m_slices + 1; n++)
				{
					...
					switch (m_uvWrapMode)
					{
						case UvwrapMode.Clamp:
							tsMesh.uv[vertIndex] = new Vector2((float)m_evalResult.percent * uvScale.x + uvOffset.x,
