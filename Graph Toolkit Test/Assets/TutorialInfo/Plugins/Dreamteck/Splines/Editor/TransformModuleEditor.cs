namespace Dreamteck.Splines.Editor
{
    ...
    {
        private TransformModule m_motionApplier;
        private string[] m_toolStrings = new string[] { "3D", "2D" };
        ...
        public override void DrawInspector()
        {
            ...
            {
                m_motionApplier.applyPosition2D = EditorGUILayout.Toggle("Apply Position", m_motionApplier.applyPosition2D);
            }
            else
            {
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Position", GUILayout.Width(EditorGUIUtility.labelWidth));
                m_motionApplier.applyPositionX = EditorGUILayout.Toggle(m_motionApplier.applyPositionX, GUILayout.Width(30));
                GUILayout.Label("X", GUILayout.Width(20));
                m_motionApplier.applyPositionY = EditorGUILayout.Toggle(m_motionApplier.applyPositionY, GUILayout.Width(30));
                GUILayout.Label("Y", GUILayout.Width(20));
                m_motionApplier.applyPositionZ = EditorGUILayout.Toggle(m_motionApplier.applyPositionZ, GUILayout.Width(30));
                GUILayout.Label("Z", GUILayout.Width(20));
                EditorGUILayout.EndHorizontal();
                EditorGUIUtility.labelWidth = 150;
                m_motionApplier.retainLocalPosition = EditorGUILayout.Toggle("Retain Local Position", m_motionApplier.retainLocalPosition);
            ...
            if (m_motionApplier.is2D)
            {
                m_motionApplier.applyRotation2D = EditorGUILayout.Toggle("Apply Rotation", m_motionApplier.applyRotation2D);
            } else
            {
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Rotation", GUILayout.Width(EditorGUIUtility.labelWidth));
                m_motionApplier.applyRotationX = EditorGUILayout.Toggle(m_motionApplier.applyRotationX, GUILayout.Width(30));
                GUILayout.Label("X", GUILayout.Width(20));
                m_motionApplier.applyRotationY = EditorGUILayout.Toggle(m_motionApplier.applyRotationY, GUILayout.Width(30));
                GUILayout.Label("Y", GUILayout.Width(20));
                m_motionApplier.applyRotationZ = EditorGUILayout.Toggle(m_motionApplier.applyRotationZ, GUILayout.Width(30));
                GUILayout.Label("Z", GUILayout.Width(20));
                EditorGUILayout.EndHorizontal();

                EditorGUIUtility.labelWidth = 150; 
                m_motionApplier.retainLocalRotation = EditorGUILayout.Toggle("Retain Local Rotation", m_motionApplier.retainLocalRotation);
                EditorGUIUtility.labelWidth = 0;
            ...
            if (m_motionApplier.applyRotation)
            {
                ...
                {
                    m_motionApplier.rotationOffset = EditorGUILayout.Vector3Field("Offset", m_motionApplier.rotationOffset);
                }
            }
            EditorGUI.indentLevel = 1;
            EditorGUILayout.BeginHorizontal();
            ...
            m_motionApplier.velocityHandleMode = (TransformModule.VelocityHandleMode)EditorGUILayout.EnumPopup("Velocity Mode", m_motionApplier.velocityHandleMode);
